...
namespace LogisticsEntity.Migrations
{
    ...
    [Migration("20240420032151_TablesSeeding")]
    partial class TablesSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LogisticsDataCore.Tables.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = 1,
                            Age = 26,
                            CreatedDateTime = "4/20/2024 5:21:51 AM",
                            Email = "abdalla.ahly@gmail.com",
                            IsVerified = true,
                            PasswordHash = "$2a$11$v99OqSGJGN/8rHYj4K07NecnjoNYiHQt/ohTePlRDTXBLzZePp6w6",
                            Phone = "01096796098",
                            Role = "Admin",
                            UserName = "Admin",
                            VerificationCodeExpireDate = new DateTime(2024, 4, 20, 5, 31, 51, 354, DateTimeKind.Local).AddTicks(5323)
                        });
                });
